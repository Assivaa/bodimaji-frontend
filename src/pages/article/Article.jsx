      ...
      <div className="article">
        ...
        <div className="article-content">
          ...
          <div className="article-description">
            ...
            melampaui ukuran 16, untuk wanita yang menjadi sasaran kata kunci
            ini, perbedaan antara kedua istilah itu penting. "Ukuran plus"
            didefinisikan sebagai ukuran apa pun di atas 16. Ini memisahkan 67%
            wanita di A.S. yang memakai ukuran 16 atau lebih dari 33% yang
            tidak. Meskipun minoritas, rentang ukuran kelompok terakhir, disebut
            sebagai ukuran "lurus", dianggap sebagai standar. Dalam memisahkan
            keduanya — menjadikan yang satu sebagai norma dan yang lainnya
            sebagai pengecualian — wanita berukuran plus secara otomatis
            “dibedakan”, menurut Alexandra Waldman, salah satu pendiri dan
            direktur kreatif Universal Standard, merek pakaian yang mengusung
            ukuran 00 hingga 40 .“Dan begitu Anda menjadi yang lain, Anda
            menjadi lebih rendah,” katanya kepada Refinery29.
            <br />
            ...
            mengerti, tapi kami hanya akan membuat tiga gaun, masing-masing
            hanya akan naik ke ukuran tertentu dan tidak ada hubungannya dengan
            apa yang biasanya kami [ jual] dan alasan pertama mengapa Anda
            mengagumi merek kami.'”
          </div>
        </div>
