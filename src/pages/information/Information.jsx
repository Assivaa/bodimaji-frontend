...
function Information() {
  return (
    <div className="Information">
      ...
      <Col><a href="/checkout/shipping"><Button size="md" style={{ fontSize: 20, width:280, height:80, backgroundColor:'darkred', fontWeight:'Bold', border:'none'}}>Continue To Shipping</Button></a></Col>
      </Row>
      </div>
